...
<script src="https://cdn.quilljs.com/1.3.6/quill.js"></script>
    ...
    <form action="<?php echo e(route('eventfinishmail.update', $event->id)); ?>" method="POST" id="form">
        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        <?php if(isset($eventfinishmail) && $eventfinishmail->text): ?>
            quillText.root.innerHTML = `<?php echo addslashes($eventfinishmail->text); ?>`;
        <?php endif; ?>
