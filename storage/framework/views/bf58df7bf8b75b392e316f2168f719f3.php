    ...
    <div class="sidebar">
        <nav class="pt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/form')); ?>" target="_blank">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/section')); ?>">
                                <p>受付区分設定</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/mypagebasic')); ?>">
                                <p>マイページ基本設定</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/finish')); ?>">
                                <p>申込完了画面設定</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/finishmail')); ?>">
                                <p>申込完了メール設定</p>
                            </a>
                        </li>
                        <!--
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/entrymail')); ?>">
                                <p>受付時本人メール（入場）</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/exitmail')); ?>">
                                <p>受付時本人メール（退場）</p>
                            </a>
                        </li>
                        -->
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/generateqr')); ?>">
                                <p>空QRコード発行</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/pdf')); ?>">
                                <p>来場証PDF</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/survey')); ?>">
                                <p>アンケート項目設定</p>
                            </a>
                        </li>
                    </ul>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/scan/1')); ?>">
                                <p>入場時スキャン</p>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/scan/2')); ?>">
                                <p>退場時スキャン</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/events/' . $event->id . '/users')); ?>">
                                <p>申込・来場者一覧</p>
                            </a>
                        </li>
                        <li class="nav-item">
