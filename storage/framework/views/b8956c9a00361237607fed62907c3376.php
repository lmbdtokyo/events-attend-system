                    ...
                    <div class="tab-pane fade show active" id="approval0">
                        ...
                        <?php else: ?>
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $pendingUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?php echo e(route('event.approval.update', [$event->id, $eventUser->id])); ?>" method="POST">
                                                    ...
                                                    <?php $__currentLoopData = ['pending_page', 'approved_page']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_qp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if(request()->filled($_qp)): ?>
                                                            <input type="hidden" name="<?php echo e($_qp); ?>" value="<?php echo e(request($_qp)); ?>">
                                                        <?php endif; ?>
                    ...
                    <div class="tab-pane fade" id="approval1">
                        ...
                        <?php else: ?>
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $approvedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($eventUser->id); ?></td>
                                            <td><?php echo e($eventUser->name); ?></td>
                                            <td><?php echo e($eventUser->furigana); ?></td>
