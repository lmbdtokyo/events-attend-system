...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('evententrymail.update', $event->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered event-setting-table">
                    ...
                    <tr>
                        ...
                        <td><textarea id="text" name="text" class="form-control"><?php echo e($evententrymail->text); ?></textarea></td>
                    </tr>
                </table>
