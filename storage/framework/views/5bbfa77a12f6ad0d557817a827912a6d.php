        ...
        <div class="card-body">
            ...
            <table class="total-table table table-bordered" style="margin-top:10px;">
                ...
                <tbody>
                    <tr>
                        <td>登録ユーザー</td>
                        <td><?php echo e(number_format($total['registered_entry_count'] ?? 0)); ?></td>
                        <td><?php echo e(number_format($total['registered_exit_count'] ?? 0)); ?></td>
                        <td><?php echo e(number_format($total['in_venue_registered'] ?? 0)); ?></td>
                    </tr>
                    <tr>
                        <td>QRユーザー</td>
                        <td><?php echo e(number_format($total['qr_entry_count'] ?? 0)); ?></td>
                        <td><?php echo e(number_format($total['qr_exit_count'] ?? 0)); ?></td>
                        <td><?php echo e(number_format($total['in_venue_qr'] ?? 0)); ?></td>
                    </tr>
                    <tr style="font-weight:bold;">
                        <td>合計</td>
                        <td><?php echo e(number_format($total['entry_count'] ?? 0)); ?></td>
                        <td><?php echo e(number_format($total['exit_count'] ?? 0)); ?></td>
                        <td><?php echo e(number_format(($total['in_venue_registered'] ?? 0) + ($total['in_venue_qr'] ?? 0))); ?></td>
                    </tr>
                </tbody>
            </table>
